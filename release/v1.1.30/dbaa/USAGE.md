...
| `/slowsql` | 慢 SQL（默认 >1s） |
| `/sqlfetch <SQL_ID/queryid/DIGEST>` | 按 ID 拉可 EXPLAIN 的完整 SQL — og v1.1.28 / PG/MySQL/Oracle v1.1.30 |
...
| openGauss `gs_stat_activity` 报缺视图 | og-lite 无此视图；v1.1.30 已自动跳过 |
