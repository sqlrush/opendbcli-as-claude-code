 ...
 *
 * delta.go
 *	  RawSample holds raw cumulative values from a single PostgreSQL
 *	  query.
 *
 *
 ...
 *
 * IDENTIFICATION
 *	  internal/postgres/monitor/dbtop/delta.go
 *
 *-------------------------------------------------------------------------
 */
package dbtop
...
// RawSample holds raw cumulative values from a single PostgreSQL query.
type RawSample struct {
	...
	WALBytes  int64     // pg_stat_wal wal_bytes (PG14+, 0 if unavailable)
	Timestamp time.Time
}
