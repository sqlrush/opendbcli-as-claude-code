 ...
 *
 * sqladvisor_skill.go
 *	  SQLAdvisorSkill provides PostgreSQL SQL performance diagnosis and
 ...
 *
 * IDENTIFICATION
 *	  internal/postgres/skill/query/sqladvisor_skill.go
 *
 *-------------------------------------------------------------------------
 */
package query
...
import (
	...
	pgsqladv "github.com/sqlrush/opendb/internal/postgres/sqladvisor"
	"github.com/sqlrush/opendb/internal/skill"
	sadv "github.com/sqlrush/opendb/internal/sqladvisor"
)

// SQLAdvisorSkill provides PostgreSQL SQL performance diagnosis and optimization suggestions.
...
func (s *SQLAdvisorSkill) Description() string                { return "PostgreSQL SQL 性能诊断与优化建议" }
...
func (s *SQLAdvisorSkill) ToolDef() skill.ToolDef {
	return skill.ToolDef{
		Name:        "sqladvisor",
		Description: "Analyze PostgreSQL SQL execution plan and provide optimization suggestions",
		Parameters: map[string]any{
			"type": "object",
			"properties": map[string]any{
				"args": map[string]any{
					"type":        "string",
					"description": "queryid from pg_stat_statements, SQL text fragment, or empty for auto top SQL analysis",
				},
			},
		},
	}
...
func (s *SQLAdvisorSkill) CLIDef() skill.CLIDef {
	return skill.CLIDef{
		...
		Usage:   "/sqladvisor [queryid | \"SQL text\"]",
		Examples: []string{
			"/sqladvisor",
			"/sqladvisor 1234567890",
