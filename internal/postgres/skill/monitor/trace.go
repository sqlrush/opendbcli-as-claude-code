...
// TraceSkill captures OS-level stack traces and generates flame graphs for PostgreSQL.
...
// NewTraceSkill creates a TraceSkill for PostgreSQL.
...
func (s *TraceSkill) lookupSources(funcs []trace.HotFunc) []trace.FuncSource {
	...
	src := s.traceCfg.SourceFor("postgres")
	if src.Dir != "" {
