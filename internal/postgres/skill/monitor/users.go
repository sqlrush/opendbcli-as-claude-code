 ...
 *
 * IDENTIFICATION
 *	  internal/postgres/skill/monitor/users.go
 *
 *-------------------------------------------------------------------------
 */
package monitor
...
func (s *UsersSkill) ToolDef() skill.ToolDef {
	return skill.ToolDef{Name: "users", Description: "Show PostgreSQL roles with login, superuser, and password expiry info"}
}
