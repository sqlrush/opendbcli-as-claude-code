 ...
 *
 * IDENTIFICATION
 *	  internal/postgres/skill/monitor/replication.go
 *
 *-------------------------------------------------------------------------
 */
package monitor
...
func (s *ReplicationSkill) ToolDef() skill.ToolDef {
	return skill.ToolDef{
		Name:        "replication",
		Description: "Show streaming replication status for primary (pg_stat_replication) or standby (pg_stat_wal_receiver)",
	}
}
