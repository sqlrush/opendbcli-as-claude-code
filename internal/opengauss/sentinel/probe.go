 ...
 *
 * probe.go
 *	  FastProbeCollector runs lightweight probes against OpenGauss every
 *	  second.
 *
 *
 ...
 *
 * IDENTIFICATION
 *	  internal/opengauss/sentinel/probe.go
 *
 *-------------------------------------------------------------------------
 */
package sentinel
...
// fastProbeSQL queries pg_stat_activity for session-based metrics.
...
// FastProbeCollector runs lightweight probes against OpenGauss every second.
