 ...
 *
 * IDENTIFICATION
 *	  internal/oracle/ruleengine/expr_ops.go
 *
 *-------------------------------------------------------------------------
 */
package ruleengine
...
var opRegistry = map[string]OpFunc{
	...
	// Count-based
	"count_gt": opGT, // array length already extracted before calling
	"count_lt": opLT,
	"count_eq": opEQ,
	...
	// Range
	"between": opBetween, // expected is [lo, hi]
...
func opBetween(actual, expected interface{}) bool {
	...
	// expected should be a slice [lo, hi]
