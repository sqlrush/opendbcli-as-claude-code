 ...
 *
 * IDENTIFICATION
 *	  internal/mysql/skill/query/sql.go
 *
 *-------------------------------------------------------------------------
 */
package query
...
func (s *SQLSkill) ToolDef() skill.ToolDef {
	return skill.ToolDef{
		Name:        "sql",
		Description: "Execute a SQL statement directly against MySQL",
		Parameters:  map[string]any{"sql": map[string]any{"type": "string", "description": "SQL statement to execute"}},
	}
}
