...
golden-tier0:
	go test -tags "$(TAGS_GOLDEN)" ./internal/opengauss/... ./internal/gaussdb ./internal/diagtrace ./internal/ui ./internal/engine/profile ./internal/engine/memory ./internal/trace ./internal/drone
